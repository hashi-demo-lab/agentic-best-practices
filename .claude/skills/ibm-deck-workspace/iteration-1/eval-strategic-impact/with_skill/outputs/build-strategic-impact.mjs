...
const cards = [
  {
    ...
    items: [
      ...
      "Build core team expertise",
    ],
    outcome: "Unified governance framework\nwith clear accountability",
    ac1: "627EEF",
    ac2: "8A3FFC",
    ac3: "D946EF",
    numColor: "8A3FFC",
  ...
  },
  {
    ...
    outcome: "80% faster onboarding with\nbuilt-in compliance",
    ac1: "0043CE",
    ac2: "0F62FE",
    ac3: "4589FF",
    numColor: "0F62FE",
  ...
  },
  {
    num: "04",
    title: "Scale",
    subtitle: "Enterprise Optimization",
    items: [
    ...
    outcome: "Enterprise-wide platform\ndriving measurable ROI",
    ac1: "0E6027",
    ac2: "198038",
    ac3: "34D478",
    numColor: "198038",
...
async function buildPresentation() {
  ...
  // Title
  slide.addText("Compounding Value Through Maturity", {
    x: 0.7,
    y: 0.65,
    w: 8.6,
    h: 0.55,
  ...
  // Subtitle
  slide.addText(
    "Each phase builds on the previous — delivering exponential returns as capabilities mature",
    {
      x: 0.7,
      y: 1.15,
      w: 8.6,
  ...
  for (let i = 0; i < cards.length; i++) {
    ...
    // Gradient accent bar at top (with borderRadius=16 for rounded cards)
  ...
  slide.addText(
    [
      ...
      {
        text: "Organizations completing all four phases report 3-5x ROI within 18 months — each phase amplifies the value of the previous.",
  ...
  // --- Write file ---
  const outputPath =
    ".claude/skills/ibm-deck-workspace/iteration-1/eval-strategic-impact/with_skill/outputs/strategic-impact.pptx";
