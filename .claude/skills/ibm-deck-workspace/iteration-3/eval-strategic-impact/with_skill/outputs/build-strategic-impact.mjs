...
// --- Shadow factories (ALWAYS fresh objects — pptxgenjs mutates these) ---
const cardShadow = () => ({
...
// --- Gradient hero title renderer (SVG -> PNG) ---
...
// --- Card data: 4 compounding value stages ---
const cards = [
  {
    num: "01",
    title: "Establish",
...
async function buildPresentation() {
  ...
  // --- Write the file ---
  const outputPath = new URL("./strategic-impact.pptx", import.meta.url).pathname;
